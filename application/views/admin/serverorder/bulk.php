	...
	<div class="col-md-12">
		...
		<div class="portlet">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-cogs"></i>Bulk Issue Server Orders
				</div>
            </div>
            <div class="portlet-body">
                <div class="table-responsive">
                    <?php echo form_open('admin/serverorder/bulk_operation',array('method' => 'post','id'=>'form')); ?>
                    <table class="table table-striped table-hover" >
                        <thead>
                            <tr>
                                <th>Refund<input type="checkbox" name="checkall" class="checkbox" id="checkAll"/></th>
                                <th width="5%">ID</th>
                                <th width="35%">Title</th>
                                <th width="20%">Required Fields</th>
