        ...
        <input type="hidden" name="ID" value="<?php echo $data[0]['ID'] ?>" />
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <?php echo form_textarea(array('name'=>"Description", 'id'=>"Description", 'style'=>"height: 300px;", 'value'=>html_entity_decode(set_value('Description', $data[0]['Description'])))); ?>
                    </div>
                </div>
...
<script>
  CKEDITOR.replace('Description', {
    ...
    filebrowserUploadUrl: '/uploads/fileservice/', // Ganti dengan endpoint upload jika sudah ada
    filebrowserUploadMethod: 'form'
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-md-6">
                        ...
                        <?php echo form_input(array('name'=>"Download", 'id'=>"Download", 'class'=>"form-control", 'placeholder'=>'https://...', 'value'=>set_value('Download', isset($data[0]['Download']) ? $data[0]['Download'] : ''))); ?>
                    </div>
                </div>
                   <div class="form-group">
                    ...
                    <div class="input-group col-md-6">
                        ...
                        <?php echo form_input(array('name'=>"Video", 'id'=>"Video", 'class'=>"form-control", 'placeholder'=>'https://...', 'value'=>set_value('Video', isset($data[0]['Video']) ? $data[0]['Video'] : ''))); ?>
                    </div>
                </div>
                <div class="form-group">
