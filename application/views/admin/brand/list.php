<div class="row">
	<div class="col-md-12">
		...
		<div class="portlet">
			...
			<?php echo form_open('admin/brand/add',array('method' => 'post','id'=>'form')); ?>
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-cogs"></i>Mobile Brands
				</div>
			</div>
			<div class="portlet-body">
				<div class="table-responsive">
					...
					<a href="<?php echo site_url('admin/brand/add') ?>"><button id="sample_editable_1_new" class="btn btn-success"> Add Brand <i class="fa fa-plus"></i></button></a>
			</div>
			<?php echo form_close(); ?>
		</div>
...
<?php }	?>	
    $('#TableDeferLoading').DataTable( {
		...
		"serverSide": true,
		"deferRender": true,
		"ajax": "<?php echo site_url('admin/brand/listener'); ?>",
		"order": [[ 0, 'asc' ]],
        "columnDefs": [
