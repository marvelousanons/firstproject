	...
	<div class="col-md-12">
		...
		<div class="portlet">
			...
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-cogs"></i>Server Boxes
				</div>
			</div>
			<div class="portlet-body">
				...
				<a href="<?php echo site_url('admin/serverbox/add') ?>"><button class="btn btn-success"> Add Server Group <i class="fa fa-plus"></i></button></a>
			</div>
		</div>
...
<?php }	?>	
    $('#TableDeferLoading').DataTable( {
		...
		"serverSide": true,
		"deferRender": true,
		"ajax": "<?php echo site_url('admin/serverbox/listener'); ?>",
		"order": [[ 0, 'asc' ]],
        "columnDefs": [
