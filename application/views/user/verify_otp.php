            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4><?php echo $this->lang->line('otp_title'); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <p><?php echo $this->lang->line('otp_instruction'); ?></p>
                        
                        <?php echo form_open('user/verify_otp'); ?>
                            <div class="form-group">
                                <label for="otp_code"><?php echo $this->lang->line('otp_code'); ?></label>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-block">
                                    <?php echo $this->lang->line('otp_verify_btn'); ?>
                                </button>
                            </div>
                        <?php echo form_close(); ?>
                        
                        <div class="text-center">
                            <a href="javascript:void(0)" id="resend_otp" class="btn btn-link">
                                <?php echo $this->lang->line('otp_resend'); ?>
                            </a>
                        </div>
                    </div>
                </div>
