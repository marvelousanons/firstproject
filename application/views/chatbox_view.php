...
<div id="chatbox-container-modern">
  ...
  <!-- Didukung oleh AI SVG Icon - horizontal layout -->
  <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;margin-top:18px;justify-content:left;margin-left:18px;">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#696b7cff" style="width:28px;height:28px;display:block;">
    ...
    <span style="font-weight:600;color:#696b7cff;font-size:1.08em;letter-spacing:0.5px;">Didukung oleh AI</span>
  </div>
